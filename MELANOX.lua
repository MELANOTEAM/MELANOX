...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local MELANOX1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..MELANOX1.server.uptime_in_days..'('..MELANOX1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..MELANOX1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..MELANOX1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..MELANOX1.stats.instantaneous_ops_per_sec..'`\n'
...
if result.status_.ID == "UserstatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, mod.photos_[0].sizes_[1].photo_.persistent_id_,'📸┋الصوره • '..rdphoto..'\n🎟┋ايديــك • '..msg.sender_user_id_..'\n🎭┋مـعرفك • '..username..'\n📌┋رتبتـك • '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n👤┋موقعـك • '..rtpa..'\n🎲┋تفاعـلك • '..Total_Msg(Msguser)..'\n💌┋رسـائلك • '..Msguser..'\n✏️┋السحكات • '..edit..'\n💎┋مجوهرآتك • '..NUMPGAME..'\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ')   
else 
if result.status_.ID == "UserstatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n🎟┋ايديــك • '..msg.sender_user_id_..'\n🎭┋مـعرفك • '..username..'\n📌┋رتبتـك •  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n👤┋موقعـك • '..rtpa..'\n🎲┋تفاعـلك • '..Total_Msg(Msguser)..'\n💌┋رسـائلك • '..Msguser..'\n✏️┋السحكات • '..edit..'\n💎┋مجوهرآتك • '..NUMPGAME..']\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ')   
else
...
-- vardump(data) 
MELANOXdx(msg.chat_id_, msg.id_, '📤┋ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┋ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┋ عدد المحظورين » ( *'..data.kicked_count_..' )*\n😼✊🏿┊ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
------------------------------------------------------------------------
local MELANOXAbot = database:get(bot_id.."MELANOX1:Add:Filter:Rp2"..text..result.chat_id_)   
if MELANOXAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┋العضو👶 : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┋["..MELANOXAbot.."] \n") 
